...
export const HotspotMarker: React.FC<HotspotMarkerProps> = ({ hotspot, language }) => {
  ...
  return (
    <Marker position={[hotspot.lat, hotspot.lng]} icon={getHotspotIcon(hotspot.severity)}>
      <Popup className="hotspot-popup" maxWidth={300}>
        <div className="p-4 min-w-64">
          <div className="flex items-start justify-between mb-3">
            <h3 className="text-lg font-semibold text-gray-900 pr-2">{hotspot.title}</h3>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2 text-xs text-gray-500">
              ...
              <span>{hotspot.createdAt.toLocaleDateString()}</span>
            </div>
          </div>
        </div>
      </Popup>
