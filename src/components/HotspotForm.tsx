...
export const HotspotForm: React.FC<HotspotFormProps> = ({
  ...
  const severityOptions: Array<{ value: Hotspot['severity']; color: string }> = [
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              >
                {photo ? (
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-sm text-gray-500">{t.uploadPhoto}</span>
                  </div>
                )}
              </label>
            </div>
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              type="submit"
              disabled={!title.trim()}
              className="flex-1 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors duration-200 font-medium"
            >
              {t.save}
            </button>
          </div>
